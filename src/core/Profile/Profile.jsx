	...
	return (
		<Base>
			<div className="relative container">
				...
				<a
					href="#"
					className="absolute top-4 left-4 w-8 h-8 rounded-full bg-white/50 hover:bg-white flex items-center justify-center"
				>
			...
			<div className="flex items-center gap-4 mt-4">
				...
				/>
				<div>
					<h2 className="text-2xl font-semibold mb-2">Fajar Std</h2>
					<span className="text-lg text-gray-500">fajar_</span>
				</div>
				<a
					href="#"
					className="py-2 px-4 rounded bg-blue-600 sm:flex items-center gap-2 text-white hover:bg-blue-700 ml-auto hidden"
				>
					<i className="bx bx-edit-alt"></i>
					Edit Profile
				</a>
