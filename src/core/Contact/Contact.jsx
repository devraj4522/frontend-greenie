...
import { submitContactForm } from "../helper/coreapicalls";
...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		// submit form
		submitContactForm({ user: user.id, title: subject, msg: msg });
	...
	return (
		<Base>
			{/* Hero */}
			<section className="bg-[#ebe7ce] text-gray-600 body-font mx-0 sm:px-12 md: pb-2 xl:px-40 lg:pb-6">
				<div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
					<div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
						<img
							className="object-cover object-center rounded"
							alt="hero"
							src="https://cdn.shopify.com/s/files/1/1780/8157/files/House_Plant_Facts_The_Health_Benefits.jpg?width=720&height=600"
						/>
					</div>
					<div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
						...
						<p className="mb-8 leading-relaxed">
							Ideally it should be a place with indirect sunlight
							and a constant temperature - that's where your plant
							will be happiest. Some plants can also tolerate a
							day in full sun, but then do ensure that it gets
							enough water. Otherwise it'll dry out and can become
							sick
						</p>
			...
			{/* Contact form */}
			<section className="bg-[#ebe7ce] text-gray-100 sm:px-12 xl:px-40 lg:py-6 pb-7 lg:pb-24 ">
				<div className="max-w-screen-xl mt-2 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
					...
					{isSubmitted ? (
						<h1 className="font-bold text-4xl text-green-500 text-center m-auto">
			...
			{/* Quote/review */}
			<section className="bg-[#ebe7ce] text-gray-600 body-font mx-0 sm:px-12 md: pb-6 xl:px-40 lg:pb-12">
				<div className="container px-5 py-6 lg-py-12 mx-auto">
					<div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
						...
						<p className="leading-relaxed text-lg">
							...
							fanny pack vaporware. Man bun next level coloring
							book skateboard four loko knausgaard. Kitsch
							keffiyeh master cleanse direct trade indigo juice
							before they sold out gentrify plaid gastropub
							normcore XOXO 90's pickled cindigo jean shorts.
							Slow-carb next level shoindigoitch ethical
							authentic, yr scenester sriracha forage franzen
