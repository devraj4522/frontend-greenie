...
const Login = () => {
  ...
  return (
    <Base>
      ...
      {error && toast.error(<Link to="/signin">Error occured Login now.</Link>)}
      {performRedirect()}
      <div className="login-main flex sm:items-center items-start min-h-screen px-3 py-6 sm:px-12 lg:justify-center">
        <div className="flex mx-auto flex-1 flex-col-reverse overflow-hidden rounded-md shadow-lg md:flex-row md:flex-1 lg:max-w-screen-md">
          <div className="p-5 bg-white md:flex-1">
            <h3 className="my-4 text-3xl font-bold text-lime-800">Welcome Back</h3>
            <form
              action="#"
            ...
            >
              ...
              <div className="flex flex-col space-y-5">
                <span className="flex items-center justify-center space-x-2">
                  ...
                  <span className="font-normal text-gray-600">Or Login With</span>
                  <span className="h-px bg-gray-400 w-14"></span>
                </span>
