...
const Review = ({ product }) => {
  ...
  const showStars = (rating) => {
    ...
    for (let i = 0; i < nonfilled; i++) {
      content.push(
        <a key={filled + i} className="inline-block text-gray-200" href="#">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
      ...
      <section className="  text-gray-600 body-font overflow-hidden">
        <div className="container ">
          <div className=" lg:w-4/5 mx-auto flex-wrap flex flex-col">
            <h3 className=" font-bold text-2xl mx-auto">Add Review</h3>
            <AddReview
              product={product.id}
              setReload={setReload}
              reload={reload}
              ...
              <div className="w-full md:w-1/2 xl:w-1/5 px-2 mb-4 md:mb-0">
                <div className=" px-4 h-full mb-4  rounded-3xl">
                  <p className="font-heading font-medium">
                    <span className="text-4xl text-slate-700">4.3</span>
                    <span className="text-slate-900">/5</span>
                  </p>
                  <div className="flex mb-3">
                    <a className="inline-block text-slate-900" href="#">
                      <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                    ...
                    <div className="flex flex-wrap">
                      ...
                      <div className="w-full md:w-1/3 text-right">
                        <p className=" text-sm text-gray-300">
                          Added{" "}
                          {getTimeAgo(item.updated_at)["data"] +
                            " " +
                            getTimeAgo(item.updated_at)["type"]}{" "}
                          ago
                        </p>
                      </div>
                    </div>
